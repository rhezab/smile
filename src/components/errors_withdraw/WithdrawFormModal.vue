  ...
  <article class="message is-danger">
    ...
    <div class="message-body has-text-left">
      <p class="has-text-left">
        <b>
          You are free to withdraw from this study at any time. Withdrawing from
          the study may affect the total amount
          of your compensation. Please complete the following form to complete
          your withdraw. We will follow up with you
          about partial compensation. You do not have to answer any particular
          question but we appreciate understanding
          the reasons for your withdraw.
        </b>
      </p>
      <br />
      <p>
        <FormKit v-model="forminfo.reason_select" type="checkbox"
          label="Why are you withdrawing from the study? (Optional)" :options="[
        ...
        ]" decorator-icon="happy" help="Select all that apply."
          validation="required|min:3" />
        <FormKit v-model="forminfo.reason_comments" type="textarea"
          label="Additional comments. (Optional)" rows="5"
          placeholder="Enter your comments here."
          help="Please let us know any additional information you would like to share." />
        <FormKit v-model="props.prefillEmail" type="email"
          ...
          validation="email" validation-visibility="live"
          placeholder="participant@gmail.com" />
      </p>
      <div class="has-text-right mt-6">
        <button class="button mr-4" id="nevermind"
          @click="$emit('toggleWithdraw')">
          Nevermind, take me back to the study!
        </button>
        <button class="button is-danger mr-3" id="finish"
