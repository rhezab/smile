...
<template>
  ...
  <div class="content">
    ...
    <p class="is-size-6">
      <a href="https://www.prolific.co" target="_new">Prolific.ac</a> is a
    ...
    <p class="is-size-6">
      <a href="https://www.cloudresearch.com" target="_new">CloudResearch</a> is
    ...
    <p class="is-size-6">
      <a href="https://www.mturk.com">Amazon Mechanical Turk</a> is the original
      wild-west 🤠 of online crowd labor markets.
    </p>
    <a href="/#/mturk/?assignmentId=ASSIGNMENT_ID_NOT_AVAILABLE&hitId=123RVWYBAZW00EXAMPLE&turkSubmitTo=https://www.mturk.com/&workerId=AZ3456EXAMPLE"
      class="button is-danger is-small" id="amt_tester_preview">AMT Preview Mode
      &nbsp;
      <FAIcon icon="fa-solid fa-arrow-right" />
    </a>
