...
<template>
  <div class="instructions">
    ...
    <p class="is-size-5 has-text-left">
      ...
      sense questions and tasks that should be easy and fun if you are a human.
    </p>
    <p class="is-size-5 has-text-left">
      Each question will need to be answered as quickly as possible. If you don't respond in time it will move to the
      next question.
    </p>
    <p class="is-size-5 has-text-left">
    ...
    <p class="is-size-5 has-text-left">
      ...
      incorrect, your response times appear irregular, you may be flagged as likely a bot and your compensation will be
      denied.
    </p>
    <hr />
