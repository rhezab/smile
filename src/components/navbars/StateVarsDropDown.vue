        ...
        <div class="dropdown-menu pt-0 mt-0" id="dropdown-menu" role="menu">
            <div class="dropdown-content">
                ...
                <div class="randomization is-right">
                    ...
                    <p class="is-left">
                        You can override or view certain user-relevant state
                    ...
                    <div class="columns">
                        <div class="column is-6">
                            <div class="field">
                                <input id="switchRoundedDefault1"
                                    type="checkbox" name="switchRoundedDefault1"
                                    class="switch is-rounded is-rtl is-small"
                                    v-model="smilestore.local.knownUser">
                                <label for="switchRoundedDefault1"><b>Is
                                        known</b>:</label>
                            </div>
                            <div class="field">
                                <input id="switchRoundedDefault2"
                                    type="checkbox" name="switchRoundedDefault2"
                                    class="switch is-rounded is-rtl is-small"
                                    v-model="smilestore.data.done">
                                <label for="switchRoundedDefault2"><b>Is
                                        done</b>:</label>
                            </div>
                        ...
                        <div class="column is-6">
                            <div class="field">
                                <input id="switchRoundedDefault3"
                                    type="checkbox" name="switchRoundedDefault3"
                                    class="switch is-rounded is-rtl is-small"
                                    v-model="smilestore.data.consented">
                                <label for="switchRoundedDefault3"><b>Has
                                        consented</b>:</label>
                            </div>
                            <div class="field">
                                <input id="switchRoundedDefault4"
                                    type="checkbox" name="switchRoundedDefault4"
                                    class="switch is-rounded is-rtl is-small"
                                    v-model="smilestore.data.withdraw">
                                <label
                                    for="switchRoundedDefault4"><b>Withdrew</b>:</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="select is-small">
                        <select v-model="smilestore.data.recruitment_service">
                            <option v-for="cond, key in smilestore.global.urls"
                                :key="cond">
                                {{ key }}
                            </option>
                        </select>
