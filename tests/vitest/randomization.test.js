...
describe('Randomization tests', () => {
  ...
  it('should generate random integers', () => {
    const randomints = Array(10000).fill().map(element => random.randomInt(1, 5)) 
  ...
  it('should shuffle arrays', () => {
    const randomarrays = Array(10000).fill().map(element => random.shuffle([1, 2, 3])) 
  ...
  it('should sample without replacement', () => {
    const randomarrays = Array(10000).fill().map(element => random.sampleWithoutReplacement([1, 2, 3], 3)) 
  ...
  it('should sample with replacement', () => {
    const randomarrays = Array(10000).fill().map(element => random.sampleWithReplacement([1, 2, 3], 3)) 
